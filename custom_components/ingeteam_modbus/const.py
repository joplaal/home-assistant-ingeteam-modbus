...
BATTERY_SENSOR_TYPES = {
    ...
    "Battery_State_of_Charge": ["Battery State of Charge", "battery_state_of_charge", "%", "mdi:battery-high"],
    "Battery_State_of_Health": ["Battery State of Health", "battery_state_of_health", "%", "mdi:battery-heart-variant"],
    ...
    "Battery_BMS_Flags": ["Battery BMS Flags", "battery_bms_flags", None, None],
    "Battery_BMS_Warnings": ["Battery BMS Warnings", "battery_bms_warnings", None, None],
